...
int Stage_obj::nmeGetStageWidth( ){
	HX_STACK_PUSH("Stage::nmeGetStageWidth","neash/display/Stage.hx",875);
	HX_STACK_THIS(this);
	HX_STACK_LINE(875)
...
int Stage_obj::nmeGetStageHeight( ){
	HX_STACK_PUSH("Stage::nmeGetStageHeight","neash/display/Stage.hx",869);
	HX_STACK_THIS(this);
	HX_STACK_LINE(869)
...
bool Stage_obj::nmeSetStageFocusRect( bool inVal){
	HX_STACK_PUSH("Stage::nmeSetStageFocusRect","neash/display/Stage.hx",862);
	HX_STACK_THIS(this);
...
bool Stage_obj::nmeGetStageFocusRect( ){
	HX_STACK_PUSH("Stage::nmeGetStageFocusRect","neash/display/Stage.hx",860);
	HX_STACK_THIS(this);
	HX_STACK_LINE(860)
...
::neash::display::StageScaleMode Stage_obj::nmeSetScaleMode( ::neash::display::StageScaleMode inMode){
	HX_STACK_PUSH("Stage::nmeSetScaleMode","neash/display/Stage.hx",854);
	HX_STACK_THIS(this);
...
::neash::display::StageScaleMode Stage_obj::nmeGetScaleMode( ){
	HX_STACK_PUSH("Stage::nmeGetScaleMode","neash/display/Stage.hx",847);
	HX_STACK_THIS(this);
	HX_STACK_LINE(848)
...
::neash::display::StageQuality Stage_obj::nmeSetQuality( ::neash::display::StageQuality inQuality){
	HX_STACK_PUSH("Stage::nmeSetQuality","neash/display/Stage.hx",840);
	HX_STACK_THIS(this);
...
::neash::display::StageQuality Stage_obj::nmeGetQuality( ){
	HX_STACK_PUSH("Stage::nmeGetQuality","neash/display/Stage.hx",833);
	HX_STACK_THIS(this);
	HX_STACK_LINE(834)
...
bool Stage_obj::nmeIsOpenGL( ){
	HX_STACK_PUSH("Stage::nmeIsOpenGL","neash/display/Stage.hx",827);
	HX_STACK_THIS(this);
	HX_STACK_LINE(827)
...
Float Stage_obj::nmeSetFrameRate( Float inRate){
	HX_STACK_PUSH("Stage::nmeSetFrameRate","neash/display/Stage.hx",819);
	HX_STACK_THIS(this);
...
::neash::display::InteractiveObject Stage_obj::nmeSetFocus( ::neash::display::InteractiveObject inObject){
	HX_STACK_PUSH("Stage::nmeSetFocus","neash/display/Stage.hx",809);
	HX_STACK_THIS(this);
...
::neash::display::InteractiveObject Stage_obj::nmeGetFocus( ){
	HX_STACK_PUSH("Stage::nmeGetFocus","neash/display/Stage.hx",801);
	HX_STACK_THIS(this);
	HX_STACK_LINE(802)
...
Float Stage_obj::nmeGetDPIScale( ){
	HX_STACK_PUSH("Stage::nmeGetDPIScale","neash/display/Stage.hx",795);
	HX_STACK_THIS(this);
	HX_STACK_LINE(795)
...
::neash::display::StageDisplayState Stage_obj::nmeSetDisplayState( ::neash::display::StageDisplayState inState){
	HX_STACK_PUSH("Stage::nmeSetDisplayState","neash/display/Stage.hx",788);
	HX_STACK_THIS(this);
...
::neash::display::StageDisplayState Stage_obj::nmeGetDisplayState( ){
	HX_STACK_PUSH("Stage::nmeGetDisplayState","neash/display/Stage.hx",781);
	HX_STACK_THIS(this);
	HX_STACK_LINE(782)
...
::neash::display::StageAlign Stage_obj::nmeSetAlign( ::neash::display::StageAlign inMode){
	HX_STACK_PUSH("Stage::nmeSetAlign","neash/display/Stage.hx",774);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inMode,"inMode");
	HX_STACK_LINE(775)
...
::neash::display::StageAlign Stage_obj::nmeGetAlign( ){
	HX_STACK_PUSH("Stage::nmeGetAlign","neash/display/Stage.hx",767);
	HX_STACK_THIS(this);
	HX_STACK_LINE(768)
...
{
		HX_STACK_PUSH("Stage::showCursor","neash/display/Stage.hx",756);
		HX_STACK_THIS(this);
...
Float Stage_obj::nmeUpdateNextWake( ){
	HX_STACK_PUSH("Stage::nmeUpdateNextWake","neash/display/Stage.hx",727);
	HX_STACK_THIS(this);
	HX_STACK_LINE(729)
...
{
		HX_STACK_PUSH("Stage::nmeStopDrag","neash/display/Stage.hx",720);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::nmeStartDrag","neash/display/Stage.hx",694);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sprite,"sprite");
...
{
		HX_STACK_PUSH("Stage::nmeSetActive","neash/display/Stage.hx",677);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::nmeRender","neash/display/Stage.hx",658);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::nmePollTimers","neash/display/Stage.hx",648);
		HX_STACK_THIS(this);
		HX_STACK_LINE(650)
...
{
		HX_STACK_PUSH("Stage::nmeOnTouch","neash/display/Stage.hx",609);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::nmeOnResize","neash/display/Stage.hx",602);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::nmeOnMouse","neash/display/Stage.hx",519);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inEvent,"inEvent");
		HX_STACK_ARG(inType,"inType");
...
{
		HX_STACK_PUSH("Stage::nmeOnKey","neash/display/Stage.hx",501);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inEvent,"inEvent");
		HX_STACK_ARG(inType,"inType");
		HX_STACK_LINE(502)
...
Void Stage_obj::nmeOnJoystick( Dynamic inEvent,::String inType){
{
		...
		if (  ( _switch_1==::neash::events::JoystickEvent_obj::AXIS_MOVE)){
			...
			HX_STACK_LINE(461)
			evt = ::neash::events::JoystickEvent_obj::__new(inType,false,false,inEvent->__Field(HX_CSTRING("id"),true),(int)0,data->__get((int)0),data->__get((int)1),data->__get((int)2));
			HX_STACK_LINE(462)
			evt->axis = data->copy();
			HX_STACK_LINE(464)
...
{
		HX_STACK_PUSH("Stage::setFixedOrientation","neash/display/Stage.hx",743);
...
bool run(int inOrientation){
	HX_STACK_PUSH("Stage::shouldRotateInterface","neash/display/Stage.hx",750);
	HX_STACK_ARG(inOrientation,"inOrientation");
	HX_STACK_LINE(750)
