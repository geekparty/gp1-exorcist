...
bool inTransparent = __o_inTransparent.Default(true);
{
	...
	if (((bool((inWidth < (int)1)) || bool((inHeight < (int)1))))){
		...
		HX_STACK_LINE(90)
		this->nmeHandle = ::neash::display::BitmapData_obj::nme_bitmap_data_create(inWidth,inHeight,flags,fill_col,fill_alpha,inGPUMode);
	}
}
;
	return null();
...
::neash::display::BitmapData BitmapData_obj::clone( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(125)
	::neash::display::BitmapData bm = ::neash::display::BitmapData_obj::__new((int)0,(int)0,null(),null(),null());		HX_STACK_VAR(bm,"bm");
	HX_STACK_LINE(126)
...
{
		HX_STACK_LINE(327)
		::neash::display::BitmapData result = ::neash::display::BitmapData_obj::__new((int)0,(int)0,null(),null(),null());		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(328)
...
struct _Function_0_5{
	...
	FORMAT_4444= (int)1;
	FORMAT_565= (int)2;
	nme_bitmap_data_create= ::neash::Loader_obj::load(HX_CSTRING("nme_bitmap_data_create"),(int)-1);
