...
{
HX_STACK_PUSH("JoystickEvent::new","neash/events/JoystickEvent.hx",22);
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_PUSH("JoystickEvent::toString","neash/events/JoystickEvent.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_LINE(42)
...
::neash::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_PUSH("JoystickEvent::clone","neash/events/JoystickEvent.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
