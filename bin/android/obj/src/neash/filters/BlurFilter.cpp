...
{
HX_STACK_PUSH("BlurFilter::new","neash/filters/BlurFilter.hx",13);
...
::neash::filters::BitmapFilter BlurFilter_obj::clone( ){
	HX_STACK_PUSH("BlurFilter::clone","neash/filters/BlurFilter.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
	return ::neash::filters::BlurFilter_obj::__new(this->blurX,this->blurY,this->quality);
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.filters.BlurFilter"), hx::TCanCast< BlurFilter_obj> ,sStaticFields,sMemberFields,
