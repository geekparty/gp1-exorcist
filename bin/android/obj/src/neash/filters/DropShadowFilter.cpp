...
{
HX_STACK_PUSH("DropShadowFilter::new","neash/filters/DropShadowFilter.hx",21);
...
::neash::filters::BitmapFilter DropShadowFilter_obj::clone( ){
	HX_STACK_PUSH("DropShadowFilter::clone","neash/filters/DropShadowFilter.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
	return ::neash::filters::DropShadowFilter_obj::__new(this->distance,this->angle,this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout,this->hideObject);
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.filters.DropShadowFilter"), hx::TCanCast< DropShadowFilter_obj> ,sStaticFields,sMemberFields,
