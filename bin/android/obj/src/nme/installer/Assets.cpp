...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::nme::installer::Assets_obj::initialized))){
			HX_STACK_LINE(30)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("libraries/game_resources.swf"),HX_CSTRING("libraries_game_resources_swf"));
			HX_STACK_LINE(31)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("libraries/game_resources.swf"),HX_CSTRING("binary"));
			HX_STACK_LINE(32)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("libraries/menu.swf"),HX_CSTRING("libraries_menu_swf"));
			HX_STACK_LINE(33)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("libraries/menu.swf"),HX_CSTRING("binary"));
			HX_STACK_LINE(34)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("img/another.png"),HX_CSTRING("img_another_png"));
			HX_STACK_LINE(35)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("img/another.png"),HX_CSTRING("image"));
			HX_STACK_LINE(36)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("img/exit.png"),HX_CSTRING("img_exit_png"));
			HX_STACK_LINE(37)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("img/exit.png"),HX_CSTRING("image"));
			HX_STACK_LINE(38)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("img/girl.json"),HX_CSTRING("img_girl_json"));
			HX_STACK_LINE(39)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("img/girl.json"),HX_CSTRING("text"));
			HX_STACK_LINE(40)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("img/girl.png"),HX_CSTRING("img_girl_png"));
			HX_STACK_LINE(41)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("img/girl.png"),HX_CSTRING("image"));
			HX_STACK_LINE(42)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("img/start.png"),HX_CSTRING("img_start_png"));
			HX_STACK_LINE(43)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("img/start.png"),HX_CSTRING("image"));
			HX_STACK_LINE(44)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/sounds/fire_loop.mp3"),HX_CSTRING("assets/sounds/fire_loop.mp3"));
			HX_STACK_LINE(45)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/sounds/fire_loop.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(46)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/sounds/growl.mp3"),HX_CSTRING("assets/sounds/growl.mp3"));
			HX_STACK_LINE(47)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/sounds/growl.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(48)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/sounds/on_playerTouch.mp3"),HX_CSTRING("assets/sounds/on_playerTouch.mp3"));
			HX_STACK_LINE(49)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/sounds/on_playerTouch.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(50)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/sounds/scream_good.mp3"),HX_CSTRING("assets/sounds/scream_good.mp3"));
			HX_STACK_LINE(51)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/sounds/scream_good.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(52)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/sounds/theme.mp3"),HX_CSTRING("assets/sounds/theme.mp3"));
			HX_STACK_LINE(53)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/sounds/theme.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(55)
...
bool useCache = __o_useCache.Default(true);
	HX_STACK_PUSH("Assets::getBitmapData","nme/installer/Assets.hx",62);
	HX_STACK_ARG(id,"id");
	HX_STACK_ARG(useCache,"useCache");
{
		...
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("image")))))){
			...
			HX_STACK_LINE(88)
			::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no BitmapData asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),88,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
			HX_STACK_LINE(90)
			return null();
		}
		HX_STACK_LINE(66)
...
::neash::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_PUSH("Assets::getBytes","nme/installer/Assets.hx",97);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(99)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(101)
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		HX_STACK_LINE(107)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no String or ByteArray asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),107,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBytes")));
		HX_STACK_LINE(109)
		return null();
	}
	HX_STACK_LINE(101)
...
::neash::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_PUSH("Assets::getFont","nme/installer/Assets.hx",116);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(118)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(120)
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("font")))))){
		...
		HX_STACK_LINE(126)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Font asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),126,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getFont")));
		HX_STACK_LINE(128)
		return null();
	}
	HX_STACK_LINE(120)
...
::String Assets_obj::getResourceName( ::String id){
	HX_STACK_PUSH("Assets::getResourceName","nme/installer/Assets.hx",135);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(137)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(139)
...
::neash::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","nme/installer/Assets.hx",144);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(146)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(148)
	...
	HX_STACK_LINE(162)
	::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),162,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getSound")));
	HX_STACK_LINE(164)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","nme/installer/Assets.hx",169);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(171)
