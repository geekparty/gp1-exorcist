...
{
HX_STACK_PUSH("Utf8::new","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",8);
{
	HX_STACK_LINE(9)
...
::String Utf8_obj::toString( ){
	HX_STACK_PUSH("Utf8::toString","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_LINE(18)
...
{
		HX_STACK_PUSH("Utf8::addChar","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",14);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(14)
		this->__s->push(c);
...
::String Utf8_obj::encode( ::String s){
	HX_STACK_PUSH("Utf8::encode","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",24);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(24)
...
::String Utf8_obj::decode( ::String s){
	HX_STACK_PUSH("Utf8::decode","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",30);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(30)
...
{
		HX_STACK_PUSH("Utf8::iter","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",34);
		HX_STACK_ARG(s,"s");
...
int Utf8_obj::charCodeAt( ::String s,int index){
	HX_STACK_PUSH("Utf8::charCodeAt","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",40);
	HX_STACK_ARG(s,"s");
...
bool Utf8_obj::validate( ::String s){
	HX_STACK_PUSH("Utf8::validate","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",45);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(46)
	try{
		HX_STACK_LINE(47)
...
int Utf8_obj::length( ::String s){
	HX_STACK_PUSH("Utf8::length","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",53);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(54)
	Array< int > array = ::__hxcpp_utf8_string_to_char_array(s);		HX_STACK_VAR(array,"array");
	HX_STACK_LINE(55)
...
int Utf8_obj::compare( ::String a,::String b){
	HX_STACK_PUSH("Utf8::compare","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",58);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(59)
...
::String Utf8_obj::sub( ::String s,int pos,int len){
	HX_STACK_PUSH("Utf8::sub","C:\\Motion-Twin\\haxe/std/cpp/_std/haxe/Utf8.hx",70);
	HX_STACK_ARG(s,"s");
