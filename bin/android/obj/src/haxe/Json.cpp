...
{
HX_STACK_PUSH("Json::new","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",43);
{
}
;
	return null();
...
::String Json_obj::parseString( ){
	HX_STACK_PUSH("Json::parseString","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",275);
	HX_STACK_THIS(this);
	HX_STACK_LINE(276)
...
Dynamic Json_obj::parseRec( ){
	HX_STACK_PUSH("Json::parseRec","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",186);
	HX_STACK_THIS(this);
	HX_STACK_LINE(186)
	while((true)){
		HX_STACK_LINE(188)
			...
			case (int)123: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_PUSH("*::closure","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",193);
						{
...
int Json_obj::nextChar( ){
	HX_STACK_PUSH("Json::nextChar","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",182);
	HX_STACK_THIS(this);
	HX_STACK_LINE(182)
...
{
		HX_STACK_PUSH("Json::invalidChar","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",177);
		HX_STACK_THIS(this);
		HX_STACK_LINE(178)
		(this->pos)--;
		HX_STACK_LINE(179)
...
Dynamic Json_obj::doParse( ::String str){
	HX_STACK_PUSH("Json::doParse","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",170);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Json::quoteUtf8","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",151);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(152)
		...
		Void run(int c){
			HX_STACK_PUSH("*::_Function_1_1","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",153);
			HX_STACK_ARG(c,"c");
			{
				HX_STACK_LINE(153)
				switch( (int)(c)){
...
{
		HX_STACK_PUSH("Json::quote","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",124);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(126)
...
{
		HX_STACK_PUSH("Json::toStringRec","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",77);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(77)
		{
							...
							if (((c == hx::ClassOf< Array<int> >()))){
								...
								if (((c == hx::ClassOf< ::Hash >()))){
									...
									struct _Function_5_1{
										inline static Dynamic Block( ){
											HX_STACK_PUSH("*::closure","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",105);
											{
												hx::Anon __result = hx::Anon_obj::Create();
												return __result;
											}
...
{
		HX_STACK_PUSH("Json::objString","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",73);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(73)
...
{
		HX_STACK_PUSH("Json::fieldsString","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",53);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
...
::String Json_obj::toString( Dynamic v){
	HX_STACK_PUSH("Json::toString","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(47)
...
Dynamic Json_obj::parse( ::String text){
	HX_STACK_PUSH("Json::parse","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",335);
...
::String Json_obj::stringify( Dynamic value){
	HX_STACK_PUSH("Json::stringify","C:\\Motion-Twin\\haxe/std/haxe/Json.hx",346);
