...
#include <neash/filters/BlurFilter.h>
...
::ru::geekparty::framework::TextureAtlas_obj::__register();
::ru::geekparty::framework::Animation_obj::__register();
::ru::geekparty::framework::AnimatedSprite_obj::__register();
::ru::geekparty::framework::IUpdatable_obj::__register();
::ru::geekparty::exorcist::screen::ScreenEvent_obj::__register();
::ru::geekparty::exorcist::player::Player_obj::__register();
::ru::geekparty::exorcist::data::GameState_obj::__register();
::ru::geekparty::exorcist::MenuScreen_obj::__register();
::ru::geekparty::exorcist::MenuEvent_obj::__register();
::ru::geekparty::exorcist::Main_obj::__register();
::ru::geekparty::exorcist::LooseScreen_obj::__register();
::ru::geekparty::exorcist::GameScreen_obj::__register();
::ru::geekparty::exorcist::screen::IScreen_obj::__register();
...
::neash::filters::GlowFilter_obj::__register();
::neash::filters::DropShadowFilter_obj::__register();
::neash::filters::BlurFilter_obj::__register();
...
::neash::display::SimpleButton_obj::__register();
...
::format::swf::FrameLabel_obj::__register();
...
::MainMenuResources_obj::__register();
::List_obj::__register();
::IntIter_obj::__register();
::IntHash_obj::__register();
::Hash_obj::__register();
::GameBackground_obj::__register();
::EndMenuResources_obj::__register();
...
::EndMenuResources_obj::__boot();
::GameBackground_obj::__boot();
::Hash_obj::__boot();
::IntHash_obj::__boot();
::IntIter_obj::__boot();
::List_obj::__boot();
::MainMenuResources_obj::__boot();
::Reflect_obj::__boot();
::Std_obj::__boot();
...
::format::swf::FrameLabel_obj::__boot();
...
::neash::display::SimpleButton_obj::__boot();
...
::neash::filters::BlurFilter_obj::__boot();
::neash::filters::DropShadowFilter_obj::__boot();
::neash::filters::GlowFilter_obj::__boot();
...
::ru::geekparty::exorcist::screen::IScreen_obj::__boot();
::ru::geekparty::exorcist::GameScreen_obj::__boot();
::ru::geekparty::exorcist::LooseScreen_obj::__boot();
::ru::geekparty::exorcist::Main_obj::__boot();
::ru::geekparty::exorcist::MenuEvent_obj::__boot();
::ru::geekparty::exorcist::MenuScreen_obj::__boot();
::ru::geekparty::exorcist::data::GameState_obj::__boot();
::ru::geekparty::exorcist::player::Player_obj::__boot();
::ru::geekparty::exorcist::screen::ScreenEvent_obj::__boot();
::ru::geekparty::framework::IUpdatable_obj::__boot();
::ru::geekparty::framework::AnimatedSprite_obj::__boot();
::ru::geekparty::framework::Animation_obj::__boot();
::ru::geekparty::framework::TextureAtlas_obj::__boot();
