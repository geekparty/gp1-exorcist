...
bool DisplayAttributes_obj::apply( ::neash::display::DisplayObject object){
	...
	if (((this->matrix != null()))){
		HX_STACK_LINE(31)
		object->nmeGetTransform()->nmeSetMatrix(this->matrix->clone());
	}
	HX_STACK_LINE(37)
	if (((this->colorTransform != null()))){
		HX_STACK_LINE(37)
		object->nmeGetTransform()->nmeSetColorTransform(this->colorTransform);
	}
	HX_STACK_LINE(43)
	object->nmeSetName(this->name);
	HX_STACK_LINE(45)
	if (((object->nmeGetFilters() != this->filters))){
		HX_STACK_LINE(45)
		object->nmeSetFilters(this->filters);
	}
	HX_STACK_LINE(51)
...
Dynamic DisplayAttributes_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"colorTransform") ) { colorTransform=inValue.Cast< ::neash::geom::ColorTransform >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.data.DisplayAttributes"), hx::TCanCast< DisplayAttributes_obj> ,sStaticFields,sMemberFields,
