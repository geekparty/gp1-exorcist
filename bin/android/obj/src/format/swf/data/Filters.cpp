...
Array< ::neash::filters::BitmapFilter > Filters_obj::readFilters( ::format::swf::data::SWFStream stream){
	...
	HX_STACK_LINE(26)
	Array< ::neash::filters::BitmapFilter > filters = Array_obj< ::neash::filters::BitmapFilter >::__new();		HX_STACK_VAR(filters,"filters");
	HX_STACK_LINE(28)
	{
		HX_STACK_LINE(28)
		...
		while(((_g < count))){
			...
			struct _Function_3_1{
				inline static ::neash::filters::BitmapFilter Block( int &filterID,::format::swf::data::SWFStream &stream,int &count,int &i){
...
::neash::filters::BitmapFilter Filters_obj::createBevelFilter( ::format::swf::data::SWFStream stream){
...
::neash::filters::BitmapFilter Filters_obj::createBlurFilter( ::format::swf::data::SWFStream stream){
	...
	HX_STACK_LINE(112)
	return ::neash::filters::BlurFilter_obj::__new(blurX,blurY,passes);
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createBlurFilter,return )

::neash::filters::BitmapFilter Filters_obj::createColorMatrixFilter( ::format::swf::data::SWFStream stream){
...
::neash::filters::BitmapFilter Filters_obj::createConvolutionFilter( ::format::swf::data::SWFStream stream){
...
::neash::filters::BitmapFilter Filters_obj::createDropShadowFilter( ::format::swf::data::SWFStream stream){
	...
	int passes = stream->readBits((int)5,null());		HX_STACK_VAR(passes,"passes");
	HX_STACK_LINE(191)
	return ::neash::filters::DropShadowFilter_obj::__new(distance,angle,color,alpha,blurX,blurY,strength,passes,innerShadow,knockout,null());
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createDropShadowFilter,return )

::neash::filters::BitmapFilter Filters_obj::createGlowFilter( ::format::swf::data::SWFStream stream){
	...
	int passes = stream->readBits((int)5,null());		HX_STACK_VAR(passes,"passes");
	HX_STACK_LINE(212)
	return ::neash::filters::GlowFilter_obj::__new(color,alpha,blurX,blurY,strength,passes,innerGlow,knockout);
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createGlowFilter,return )

::neash::filters::BitmapFilter Filters_obj::createGradientBevelFilter( ::format::swf::data::SWFStream stream){
...
::neash::filters::BitmapFilter Filters_obj::createGradientGlowFilter( ::format::swf::data::SWFStream stream){
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.data.Filters"), hx::TCanCast< Filters_obj> ,sStaticFields,sMemberFields,
