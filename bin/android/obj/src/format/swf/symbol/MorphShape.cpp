						...
						Dynamic command = _switch_1->__Param(0);
{
		...
		if ((!(edge))){
			...
			Void run(::neash::display::Graphics g,Float f){
...
bool MorphShape_obj::render( ::neash::display::Graphics graphics,Float f){
	...
	HX_STACK_LINE(695)
	{
		...
		while(((_g < numStyles))){
			...
			if (((version == (int)1))){
				...
				Array< Float > w1 = Array_obj< Float >::__new().Add((stream->readDepth() * 0.05));		HX_STACK_VAR(w1,"w1");
				HX_STACK_LINE(723)
				Array< ::neash::display::CapsStyle > startCaps = Array_obj< ::neash::display::CapsStyle >::__new().Add(stream->readCapsStyle());		HX_STACK_VAR(startCaps,"startCaps");
				HX_STACK_LINE(724)
				Array< ::neash::display::JointStyle > joints = Array_obj< ::neash::display::JointStyle >::__new().Add(stream->readJoinStyle());		HX_STACK_VAR(joints,"joints");
				HX_STACK_LINE(725)
				bool hasFill = stream->readBool();		HX_STACK_VAR(hasFill,"hasFill");
				HX_STACK_LINE(726)
				Array< ::neash::display::LineScaleMode > scale = Array_obj< ::neash::display::LineScaleMode >::__new().Add(stream->readScaleMode());		HX_STACK_VAR(scale,"scale");
				HX_STACK_LINE(727)
				...
				HX_STACK_LINE(730)
				::neash::display::CapsStyle endCaps = stream->readCapsStyle();		HX_STACK_VAR(endCaps,"endCaps");
				HX_STACK_LINE(732)
				Array< Float > miter = Array_obj< Float >::__new().Add(1.0);		HX_STACK_VAR(miter,"miter");
				HX_STACK_LINE(734)
				if (((joints->__get((int)0) == ::neash::display::JointStyle_obj::MITER_dyn()))){
					HX_STACK_LINE(734)
				...
				if ((!(hasFill))){
					...
					HX_BEGIN_LOCAL_FUNC_S11(hx::LocalFunc,_Function_5_1,Array< bool >,pixelHint,Array< Float >,w0,Array< Float >,miter,Array< int >,c1,Array< ::neash::display::LineScaleMode >,scale,Array< int >,c0,Array< Float >,A1,Array< ::neash::display::CapsStyle >,startCaps,Array< Float >,A0,Array< ::neash::display::JointStyle >,joints,Array< Float >,w1)
					Void run(::neash::display::Graphics g,Float f){
						...
						{
							HX_STACK_LINE(747)
							g->lineStyle((w0->__get((int)0) + (((w1->__get((int)0) - w0->__get((int)0))) * f)),::format::swf::symbol::MorphShape_obj::interpolateColor(c0->__get((int)0),c1->__get((int)0),f),(A0->__get((int)0) + (((A1->__get((int)0) - A0->__get((int)0))) * f)),pixelHint->__get((int)0),scale->__get((int)0),startCaps->__get((int)0),joints->__get((int)0),miter->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC2((void))
					...
					if (((((int(fill) & int((int)16))) != (int)0))){
						HX_STACK_LINE(760)
						Array< ::neash::geom::Matrix > matrix0 = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix0,"matrix0");
						HX_STACK_LINE(762)
						stream->alignBits();
						HX_STACK_LINE(764)
						Array< ::neash::geom::Matrix > matrix1 = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix1,"matrix1");
						HX_STACK_LINE(766)
						stream->alignBits();
						HX_STACK_LINE(771)
						Array< int > numColors = Array_obj< int >::__new().Add(stream->readBits((int)4,null()));		HX_STACK_VAR(numColors,"numColors");
						HX_STACK_LINE(773)
						Array< Array< int > > colors0 = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(colors0,"colors0");
						HX_STACK_LINE(774)
						Array< Array< int > > colors1 = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(colors1,"colors1");
						HX_STACK_LINE(775)
						Array< Array< Float > > alphas0 = Array_obj< Array< Float > >::__new().Add(Array_obj< Float >::__new());		HX_STACK_VAR(alphas0,"alphas0");
						HX_STACK_LINE(776)
						Array< Array< Float > > alphas1 = Array_obj< Array< Float > >::__new().Add(Array_obj< Float >::__new());		HX_STACK_VAR(alphas1,"alphas1");
						HX_STACK_LINE(777)
						Array< Array< int > > ratios0 = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(ratios0,"ratios0");
						HX_STACK_LINE(778)
						Array< Array< int > > ratios1 = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(ratios1,"ratios1");
						HX_STACK_LINE(780)
						{
							HX_STACK_LINE(780)
							...
							while(((_g1 < numColors->__get((int)0)))){
								...
								HX_STACK_LINE(782)
								ratios0->__get((int)0)->push(stream->readByte());
								HX_STACK_LINE(783)
								colors0->__get((int)0)->push(stream->readRGB());
								HX_STACK_LINE(784)
								alphas0->__get((int)0)->push((Float(stream->readByte()) / Float(255.0)));
								HX_STACK_LINE(785)
								ratios1->__get((int)0)->push(stream->readByte());
								HX_STACK_LINE(786)
								colors1->__get((int)0)->push(stream->readRGB());
								HX_STACK_LINE(787)
								alphas1->__get((int)0)->push((Float(stream->readByte()) / Float(255.0)));
							}
						}

						HX_BEGIN_LOCAL_FUNC_S9(hx::LocalFunc,_Function_6_1,Array< Array< int > >,ratios1,Array< ::neash::geom::Matrix >,matrix0,Array< Array< int > >,ratios0,Array< Array< int > >,colors1,Array< Array< int > >,colors0,Array< Array< Float > >,alphas1,Array< int >,numColors,Array< Array< Float > >,alphas0,Array< ::neash::geom::Matrix >,matrix1)
						Void run(::neash::display::Graphics g,Float f){
							...
							HX_STACK_ARG(f,"f");
							{
								...
								HX_STACK_LINE(801)
								{
									...
									while(((_g1 < numColors->__get((int)0)))){
										...
										int i1 = (_g1)++;		HX_STACK_VAR(i1,"i1");
										HX_STACK_LINE(803)
										cols->push(::format::swf::symbol::MorphShape_obj::interpolateColor(colors0->__get((int)0)->__get(i1),colors1->__get((int)0)->__get(i1),f));
										HX_STACK_LINE(804)
										alphas->push((alphas0->__get((int)0)->__get(i1) + (((alphas1->__get((int)0)->__get(i1) - alphas0->__get((int)0)->__get(i1))) * f)));
										HX_STACK_LINE(805)
										ratios->push((ratios0->__get((int)0)->__get(i1) + (((ratios1->__get((int)0)->__get(i1) - ratios0->__get((int)0)->__get(i1))) * f)));
									}
								}
								HX_STACK_LINE(809)
								g->lineGradientStyle(::neash::display::GradientType_obj::LINEAR_dyn(),cols,alphas,ratios,::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0),matrix1->__get((int)0),f),null(),null(),null());
							}
							return null();
						}
						HX_END_LOCAL_FUNC2((void))
		...
		while(((_g < count))){
			...
			if (((fill == ::format::swf::symbol::MorphShape_obj::ftSolid))){
				...
				if (((((int(fill) & int((int)16))) != (int)0))){
					...
					HX_BEGIN_LOCAL_FUNC_S9(hx::LocalFunc,_Function_5_1,Array< Array< int > >,ratios1,Array< ::neash::geom::Matrix >,matrix0,Array< Array< int > >,ratios0,Array< Array< int > >,colors1,Array< Array< int > >,colors0,Array< Array< Float > >,alphas1,Array< int >,numColors,Array< Array< Float > >,alphas0,Array< ::neash::geom::Matrix >,matrix1)
					Void run(::neash::display::Graphics g,Float f){
						...
						HX_STACK_ARG(f,"f");
						{
							...
							HX_STACK_LINE(565)
							g->beginGradientFill(::neash::display::GradientType_obj::LINEAR_dyn(),cols,alphas,ratios,::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0),matrix1->__get((int)0),f),null(),null(),null());
						}
						return null();
					}
					HX_END_LOCAL_FUNC2((void))
					...
					if (((((int(fill) & int((int)64))) != (int)0))){
						...
						HX_STACK_LINE(574)
						Array< ::neash::display::BitmapData > bitmap = Array_obj< ::neash::display::BitmapData >::__new().Add(null());		HX_STACK_VAR(bitmap,"bitmap");
						HX_STACK_LINE(576)
						if (((id->__get((int)0) != (int)65535))){
							HX_STACK_LINE(576)
							{
								::format::swf::symbol::Symbol _switch_3 = (this->swf->getSymbol(id->__get((int)0)));
										...
										::format::swf::symbol::Bitmap data = _switch_3->__Param(0);
{
						...
						Array< ::neash::geom::Matrix > matrix0 = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix0,"matrix0");
						HX_STACK_LINE(597)
						hx::MultEq(matrix0->__get((int)0)->a,0.05);
						HX_STACK_LINE(598)
						hx::MultEq(matrix0->__get((int)0)->b,0.05);
						HX_STACK_LINE(599)
						hx::MultEq(matrix0->__get((int)0)->c,0.05);
						HX_STACK_LINE(600)
						hx::MultEq(matrix0->__get((int)0)->d,0.05);
						HX_STACK_LINE(602)
						stream->alignBits();
						HX_STACK_LINE(604)
						Array< ::neash::geom::Matrix > matrix1 = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix1,"matrix1");
						HX_STACK_LINE(608)
						hx::MultEq(matrix1->__get((int)0)->a,0.05);
						HX_STACK_LINE(609)
						hx::MultEq(matrix1->__get((int)0)->b,0.05);
						HX_STACK_LINE(610)
						hx::MultEq(matrix1->__get((int)0)->c,0.05);
						HX_STACK_LINE(611)
						hx::MultEq(matrix1->__get((int)0)->d,0.05);
						HX_STACK_LINE(613)
						stream->alignBits();
						HX_STACK_LINE(618)
						if (((bitmap->__get((int)0) != null()))){

							HX_BEGIN_LOCAL_FUNC_S3(hx::LocalFunc,_Function_7_1,Array< ::neash::geom::Matrix >,matrix0,Array< ::neash::display::BitmapData >,bitmap,Array< ::neash::geom::Matrix >,matrix1)
							Void run(::neash::display::Graphics g,Float f){
								...
								{
									HX_STACK_LINE(620)
									g->beginBitmapFill(bitmap->__get((int)0),::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0),matrix1->__get((int)0),f),null(),null());
								}
								return null();
							}
							HX_END_LOCAL_FUNC2((void))
							...
							HX_STACK_LINE(630)
							Array< ::format::SWF > s = Array_obj< ::format::SWF >::__new().Add(this->swf);		HX_STACK_VAR(s,"s");
							HX_STACK_LINE(631)
							Array< ::format::swf::symbol::MorphShape > me = Array_obj< ::format::swf::symbol::MorphShape >::__new().Add(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(me,"me");

							HX_BEGIN_LOCAL_FUNC_S6(hx::LocalFunc,_Function_7_1,Array< ::neash::geom::Matrix >,matrix0,Array< ::neash::display::BitmapData >,bitmap,Array< int >,id,Array< ::format::SWF >,s,Array< ::format::swf::symbol::MorphShape >,me,Array< ::neash::geom::Matrix >,matrix1)
							Void run(::neash::display::Graphics g,Float f){
								...
								HX_STACK_ARG(f,"f");
								{
									...
									if (((bitmap->__get((int)0) == null()))){
										...
										if (((id->__get((int)0) != (int)65535))){
											HX_STACK_LINE(637)
											{
												::format::swf::symbol::Symbol _switch_4 = (s->__get((int)0)->getSymbol(id->__get((int)0)));
														...
														::format::swf::symbol::Bitmap data = _switch_4->__Param(0);
{
										...
										if (((bitmap->__get((int)0) == null()))){
											HX_STACK_LINE(654)
											me->__get((int)0)->waitingLoader = true;
											HX_STACK_LINE(655)
											g->endFill();
											HX_STACK_LINE(657)
											return null();
...
::neash::geom::Matrix MorphShape_obj::interpolateMatrix( ::neash::geom::Matrix matrix0,::neash::geom::Matrix matrix1,Float f){
	...
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(467)
	::neash::geom::Matrix matrix = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(matrix,"matrix");
	HX_STACK_LINE(469)
...
Dynamic MorphShape_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"bounds1") ) { bounds1=inValue.Cast< ::neash::geom::Rectangle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"bounds0") ) { bounds0=inValue.Cast< ::neash::geom::Rectangle >(); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"edgeBounds1") ) { edgeBounds1=inValue.Cast< ::neash::geom::Rectangle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"edgeBounds0") ) { edgeBounds0=inValue.Cast< ::neash::geom::Rectangle >(); return inValue; }
		break;
	case 12:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.symbol.MorphShape"), hx::TCanCast< MorphShape_obj> ,sStaticFields,sMemberFields,
