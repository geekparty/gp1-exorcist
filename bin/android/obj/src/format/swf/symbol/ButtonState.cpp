...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.symbol.ButtonState"), hx::TCanCast< ButtonState_obj >,sStaticFields,sMemberFields,
...
{
Static(DOWN) = hx::CreateEnum< ButtonState_obj >(HX_CSTRING("DOWN"),2);
Static(HIT_TEST) = hx::CreateEnum< ButtonState_obj >(HX_CSTRING("HIT_TEST"),3);
Static(NONE) = hx::CreateEnum< ButtonState_obj >(HX_CSTRING("NONE"),4);
Static(OVER) = hx::CreateEnum< ButtonState_obj >(HX_CSTRING("OVER"),1);
Static(UP) = hx::CreateEnum< ButtonState_obj >(HX_CSTRING("UP"),0);
}
