...
HX_STACK_PUSH("Shape::new","format/swf/symbol/Shape.hx",40);
{
	...
	HX_STACK_LINE(86)
	Array< ::format::swf::symbol::ShapeEdge > fills = Array_obj< ::format::swf::symbol::ShapeEdge >::__new();		HX_STACK_VAR(fills,"fills");
	HX_STACK_LINE(88)
	while((true)){
		HX_STACK_LINE(90)
		...
		if ((!(edge))){
			...
			if ((moveTo)){
				...
				Void run(::neash::display::Graphics g){
			...
			if ((newStyles)){
				...
				if (((fills->length > (int)0))){
					HX_STACK_LINE(176)
					fills = Array_obj< ::format::swf::symbol::ShapeEdge >::__new();
				}
				HX_STACK_LINE(182)
				stream->alignBits();
				HX_STACK_LINE(184)
...
bool Shape_obj::render( ::neash::display::Graphics graphics){
	...
	HX_STACK_LINE(597)
	{
		...
		while(((_g < count))){
			...
			if (((version >= (int)4))){
				...
				HX_STACK_LINE(613)
				Array< Float > miter = Array_obj< Float >::__new().Add((  (((joints->__get((int)0) == ::neash::display::JointStyle_obj::MITER_dyn()))) ? Float((Float(stream->readDepth()) / Float(256.0))) : Float((int)1) ));		HX_STACK_VAR(miter,"miter");
				HX_STACK_LINE(614)
				...
				if ((hasFill)){
					...
					if (((((int(fill) & int((int)16))) != (int)0))){
						HX_STACK_LINE(624)
						Array< ::neash::geom::Matrix > matrix = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix,"matrix");
						HX_STACK_LINE(626)
						stream->alignBits();
						HX_STACK_LINE(628)
						Array< ::neash::display::SpreadMethod > spread = Array_obj< ::neash::display::SpreadMethod >::__new().Add(stream->readSpreadMethod());		HX_STACK_VAR(spread,"spread");
						HX_STACK_LINE(629)
						Array< ::neash::display::InterpolationMethod > interp = Array_obj< ::neash::display::InterpolationMethod >::__new().Add(stream->readInterpolationMethod());		HX_STACK_VAR(interp,"interp");
						HX_STACK_LINE(630)
						int numColors = stream->readBits((int)4,null());		HX_STACK_VAR(numColors,"numColors");
						HX_STACK_LINE(632)
						Array< Array< int > > colors = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(colors,"colors");
						HX_STACK_LINE(633)
						Array< Array< Float > > alphas = Array_obj< Array< Float > >::__new().Add(Array_obj< Float >::__new());		HX_STACK_VAR(alphas,"alphas");
						HX_STACK_LINE(634)
						Array< Array< int > > ratios = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());		HX_STACK_VAR(ratios,"ratios");
						HX_STACK_LINE(636)
						{
							HX_STACK_LINE(636)
							...
							while(((_g1 < numColors))){
								...
								HX_STACK_LINE(638)
								ratios->__get((int)0)->push(stream->readByte());
								HX_STACK_LINE(639)
								colors->__get((int)0)->push(stream->readRGB());
								HX_STACK_LINE(640)
								alphas->__get((int)0)->push((Float(stream->readByte()) / Float(255.0)));
							}
						}
						HX_STACK_LINE(644)
						...
						HX_STACK_LINE(645)
						Array< ::neash::display::GradientType > type = Array_obj< ::neash::display::GradientType >::__new().Add((  (((fill == ::format::swf::symbol::Shape_obj::ftLinear))) ? ::neash::display::GradientType(::neash::display::GradientType_obj::LINEAR_dyn()) : ::neash::display::GradientType(::neash::display::GradientType_obj::RADIAL_dyn()) ));		HX_STACK_VAR(type,"type");

						HX_BEGIN_LOCAL_FUNC_S14(hx::LocalFunc,_Function_6_1,Array< bool >,pixelHint,Array< Float >,width,Array< Float >,miter,Array< Float >,focus,Array< ::neash::display::LineScaleMode >,scale,Array< Array< int > >,ratios,Array< Array< Float > >,alphas,Array< ::neash::display::CapsStyle >,startCaps,Array< ::neash::display::JointStyle >,joints,Array< ::neash::display::SpreadMethod >,spread,Array< ::neash::geom::Matrix >,matrix,Array< ::neash::display::GradientType >,type,Array< Array< int > >,colors,Array< ::neash::display::InterpolationMethod >,interp)
						Void run(::neash::display::Graphics g){
							HX_STACK_PUSH("*::_Function_6_1","format/swf/symbol/Shape.hx",647);
							HX_STACK_ARG(g,"g");
							{
								HX_STACK_LINE(649)
								g->lineStyle(width->__get((int)0),(int)0,(int)1,pixelHint->__get((int)0),scale->__get((int)0),startCaps->__get((int)0),joints->__get((int)0),miter->__get((int)0));
								HX_STACK_LINE(650)
								g->lineGradientStyle(type->__get((int)0),colors->__get((int)0),alphas->__get((int)0),ratios->__get((int)0),matrix->__get((int)0),spread->__get((int)0),interp->__get((int)0),focus->__get((int)0));
							}
							return null();
						}
						HX_END_LOCAL_FUNC1((void))
					...
					HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_5_1,Array< bool >,pixelHint,Array< Float >,width,Array< Float >,miter,Array< int >,color,Array< ::neash::display::LineScaleMode >,scale,Array< ::neash::display::CapsStyle >,startCaps,Array< ::neash::display::JointStyle >,joints,Array< Float >,A)
					Void run(::neash::display::Graphics g){
						HX_STACK_PUSH("*::_Function_5_1","format/swf/symbol/Shape.hx",662);
						HX_STACK_ARG(g,"g");
						{
							HX_STACK_LINE(662)
							g->lineStyle(width->__get((int)0),color->__get((int)0),A->__get((int)0),pixelHint->__get((int)0),scale->__get((int)0),startCaps->__get((int)0),joints->__get((int)0),miter->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC1((void))
				...
				if (((bool((bool((fill == ::format::swf::symbol::Shape_obj::ftLinear)) || bool((fill == ::format::swf::symbol::Shape_obj::ftRadial)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftRadialF))))){
					...
					HX_STACK_LINE(454)
					{
						...
						while(((_g1 < numColors))){
							...
							colors->__get((int)0)->push(stream->readRGB());
							HX_STACK_LINE(458)
							alphas->__get((int)0)->push((  (((version >= (int)3))) ? Float((Float(stream->readByte()) / Float(255.0))) : Float(1.0) ));
						}
					}
					HX_STACK_LINE(462)
					Array< Float > focus = Array_obj< Float >::__new().Add((  (((fill == ::format::swf::symbol::Shape_obj::ftRadialF))) ? Float((Float(stream->readByte()) / Float(255.0))) : Float(0.0) ));		HX_STACK_VAR(focus,"focus");
					...
					HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_5_1,Array< Float >,focus,Array< Array< int > >,ratios,Array< Array< Float > >,alphas,Array< ::neash::display::SpreadMethod >,spread,Array< ::neash::geom::Matrix >,matrix,Array< ::neash::display::GradientType >,type,Array< Array< int > >,colors,Array< ::neash::display::InterpolationMethod >,interp)
					Void run(::neash::display::Graphics g){
						HX_STACK_PUSH("*::_Function_5_1","format/swf/symbol/Shape.hx",467);
						HX_STACK_ARG(g,"g");
						{
							HX_STACK_LINE(467)
							g->beginGradientFill(type->__get((int)0),colors->__get((int)0),alphas->__get((int)0),ratios->__get((int)0),matrix->__get((int)0),spread->__get((int)0),interp->__get((int)0),focus->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC1((void))
					...
					if (((bool((bool((bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapRepeatSmooth)) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapClippedSmooth)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapRepeat)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapClipped))))){
						...
						Array< ::neash::geom::Matrix > matrix = Array_obj< ::neash::geom::Matrix >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix,"matrix");
						HX_STACK_LINE(484)
						hx::MultEq(matrix->__get((int)0)->a,0.05);
						HX_STACK_LINE(485)
						hx::MultEq(matrix->__get((int)0)->b,0.05);
						HX_STACK_LINE(486)
						hx::MultEq(matrix->__get((int)0)->c,0.05);
						HX_STACK_LINE(487)
						hx::MultEq(matrix->__get((int)0)->d,0.05);
						HX_STACK_LINE(489)
						stream->alignBits();
						HX_STACK_LINE(491)
						...
						if (((id->__get((int)0) != (int)65535))){
							HX_STACK_LINE(496)
							{
								::format::swf::symbol::Symbol _switch_1 = (this->swf->getSymbol(id->__get((int)0)));
										...
										::format::swf::symbol::Bitmap data = _switch_1->__Param(0);
{
						...
						if (((bitmap->__get((int)0) != null()))){
							...
							HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_7_1,Array< bool >,repeat,Array< ::neash::display::BitmapData >,bitmap,Array< ::neash::geom::Matrix >,matrix,Array< bool >,smooth)
							Void run(::neash::display::Graphics g){
								HX_STACK_PUSH("*::_Function_7_1","format/swf/symbol/Shape.hx",519);
								HX_STACK_ARG(g,"g");
								{
									HX_STACK_LINE(519)
									g->beginBitmapFill(bitmap->__get((int)0),matrix->__get((int)0),repeat->__get((int)0),smooth->__get((int)0));
								}
								return null();
							}
							HX_END_LOCAL_FUNC1((void))
							...
							HX_STACK_LINE(530)
							Array< ::format::swf::symbol::Shape > me = Array_obj< ::format::swf::symbol::Shape >::__new().Add(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(me,"me");

							HX_BEGIN_LOCAL_FUNC_S7(hx::LocalFunc,_Function_7_1,Array< bool >,smooth,Array< ::format::SWF >,s,Array< ::format::swf::symbol::Shape >,me,Array< int >,id,Array< bool >,repeat,Array< ::neash::geom::Matrix >,matrix,Array< ::neash::display::BitmapData >,bitmap)
							Void run(::neash::display::Graphics g){
								...
								HX_STACK_ARG(g,"g");
								{
									...
									if (((bitmap->__get((int)0) == null()))){
										...
										if (((id->__get((int)0) != (int)65535))){
											HX_STACK_LINE(536)
											{
												::format::swf::symbol::Symbol _switch_2 = (s->__get((int)0)->getSymbol(id->__get((int)0)));
...
Void Shape_obj::flushCommands( Dynamic edges,Array< ::format::swf::symbol::ShapeEdge > fills){
{
		...
		while(((left > (int)0))){
			HX_STACK_LINE(315)
			::format::swf::symbol::ShapeEdge first = fills->__get((int)0);		HX_STACK_VAR(first,"first");
			HX_STACK_LINE(316)
			fills[(int)0] = fills->__get(--(left));
			HX_STACK_LINE(318)
			...
			Void run(::neash::display::Graphics gfx){
			...
			while((!(loop))){
				...
				HX_STACK_LINE(344)
				{
					...
					while(((_g < left))){
						...
						int i = (_g)++;		HX_STACK_VAR(i,"i");
						HX_STACK_LINE(346)
						if ((prev->connects(fills->__get(i)))){
							HX_STACK_LINE(348)
							prev = fills->__get(i);
							HX_STACK_LINE(349)
							fills[i] = fills->__get(--(left));
							HX_STACK_LINE(351)
...
Dynamic Shape_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"edgeBounds") ) { edgeBounds=inValue.Cast< ::neash::geom::Rectangle >(); return inValue; }
		break;
	case 12:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.symbol.Shape"), hx::TCanCast< Shape_obj> ,sStaticFields,sMemberFields,
