...
bool MorphObject_obj::setRatio( int ratio){
	...
	HX_STACK_LINE(30)
	return this->data->render(this->nmeGetGraphics(),f);
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.MorphObject"), hx::TCanCast< MorphObject_obj> ,sStaticFields,sMemberFields,
