...
{
HX_STACK_PUSH("FrameLabel::new","format/swf/FrameLabel.hx",10);
{
	HX_STACK_LINE(12)
	this->frame = frame;
	HX_STACK_LINE(13)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("format.swf.FrameLabel"), hx::TCanCast< FrameLabel_obj> ,sStaticFields,sMemberFields,
