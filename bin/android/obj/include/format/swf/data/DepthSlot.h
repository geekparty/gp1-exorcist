...
class DepthSlot_obj : public hx::Object{
	public:
	...
	public:
		...
		virtual Void move( int frame,::neash::geom::Matrix matrix,::neash::geom::ColorTransform colorTransform,Dynamic ratio);
		Dynamic move_dyn();

		virtual int findClosestFrame( int hintFrame,int frame);
		Dynamic findClosestFrame_dyn();

		::format::swf::data::DisplayAttributes cacheAttributes; /* REM */ 
		int symbolID; /* REM */ 
		::format::swf::symbol::Symbol symbol; /* REM */ 
		Array< ::format::swf::data::DisplayAttributes > attributes; /* REM */ 
};
