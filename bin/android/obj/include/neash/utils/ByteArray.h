...
class ByteArray_obj : public ::haxe::io::Bytes_obj{
	...
	public:
		...
		inline operator ::neash::utils::IMemoryRange_obj *()
			{ return new ::neash::utils::IMemoryRange_delegate_< ByteArray_obj >(this); }
		...
		virtual ::neash::utils::ByteArray getByteBuffer( );
		Dynamic getByteBuffer_dyn();

		virtual int getLength( );
		Dynamic getLength_dyn();

		virtual ::neash::utils::ByteArray slice( int inBegin,Dynamic inEnd);
		Dynamic slice_dyn();
